...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
        ...
        if (balanceAfter == balanceBefore - withdrawAmount )
            System.out.println(TestUtils.TEXT_COLOR_GREEN + "testWithdraw: TC1 passed"+ TestUtils.TEXT_COLOR_RESET);
        else {
            System.out.println(TestUtils.TEXT_COLOR_RED + "testWithdraw: TC1 FAILED XXX: balanceBefore - withdrawAmount != balanceAfter");
            System.out.format("testWithdraw: balanceBefore = %.2f ; withdrawAmount = %.2f ; balanceAfter = %.2f %s\n",
